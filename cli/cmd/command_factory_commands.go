...
• Environment setup issues`,
	...
	cmd.Flags().Bool("unjam", false, "Remediate stale DDx execute-bead worktree registrations")
	cmd.Flags().Bool("fix", false, "Automatically remediate detected git-repo corruption (core.bare/core.worktree/core.hooksPath)")
	cmd.Flags().Bool("unjam", false, "Checkpoint DDx-owned dirt and stash preserve-ref dirt while reporting operator-authored paths")
