...
// authCancelPatterns are substrings (lowercased) in stderr/stdout that indicate
// the subprocess will never succeed and should be cancelled immediately.
var authCancelPatterns = []string{
	"429",
	"401",
	"403",
	"rate limit",
...
// matchesCancelPattern returns the matched pattern if line contains a known
