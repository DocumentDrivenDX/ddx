...
// This prevents GIT_INDEX_FILE, GIT_DIR, and similar vars set by git hooks from
// leaking into subprocess git commands and corrupting index/repository references.
