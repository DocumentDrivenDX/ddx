...
func ReportFromExecuteBeadResult(res *ExecuteBeadResult, powerClass string) ExecuteBeadReport {
	...
	return ExecuteBeadReport{
		...
		ReviewVerdict:                res.ReviewVerdict,
		ReviewRationale:              res.ReviewRationale,
		ReviewSkipReason:             res.ReviewSkipReason,
		...
		ReusableWorkspaceSlotHits:    res.ReusableWorkspaceSlotHits,
		ReusableWorkspaceSlotMisses:  res.ReusableWorkspaceSlotMisses,
