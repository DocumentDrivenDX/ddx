...
func (w *ExecuteBeadWorker) nextCandidate(attempted map[string]struct{}, labelFilter string, targetBeadIDs ...string) (bead.Bead, []pickerSkip, bool, error) {
	targetBeadID := ""
	if len(targetBeadIDs) > 0 {
		targetBeadID = targetBeadIDs[0]
	}
