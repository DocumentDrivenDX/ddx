...
func toTryReport(report ExecuteBeadReport) agenttry.Report {
	...
	return agenttry.Report{
		...
		NoEvidencePaths:              append([]string(nil), report.NoEvidencePaths...),
		...
		ReusableWorkspaceSlotHits:    report.ReusableWorkspaceSlotHits,
		ReusableWorkspaceSlotMisses:  report.ReusableWorkspaceSlotMisses,
		ReusableWorkspaceTimeSavedMS: report.ReusableWorkspaceTimeSavedMS,
		ReusableWorkspaceBytesSaved:  report.ReusableWorkspaceBytesSaved,
		DurationMS:                   report.DurationMS,
		FizeauOutcome:                report.FizeauOutcome,
		FizeauCause:                  report.FizeauCause,
		FizeauStage:                  report.FizeauStage,
		DDxOwnerStage:                report.DDxOwnerStage,
		AttemptPolicyAction:          report.AttemptPolicyAction,
		AttemptPolicyReason:          report.AttemptPolicyReason,
